    ...
    <div class="container">
        <div class="row g-4"> 
            ...
            <div v-if="localMessage" :class="['alert', localMessageType === 'error' ? 'alert-danger' : localMessageType === 'success' ? 'alert-success' : 'alert-info', 'alert-dismissible']">
                ...
                <button type="button" class="btn-close" @click="localMessage = ''" 
                aria-label="Fechar a mensagem" alt="Fechar a mensagem"></button>
            </div>

            <div class="col-12 col-md-6 col-lg-4 mx-auto">
                <div class="card login-form">
                    <div class="card-body">
                        <h1 class="card-title text-center fs-3">Acesso ao sistema</h1>
